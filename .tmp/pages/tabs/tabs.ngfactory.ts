...
function viewFactory_TabsPage_Host0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import3.AppElement):import1.AppView<any> {
  if ((renderType_TabsPage_Host === (null as any))) { (renderType_TabsPage_Host = viewUtils.createRenderComponentType('',0,import15.ViewEncapsulation.None,([] as any[]),{})); }
  return new _View_TabsPage_Host0(viewUtils,parentInjector,declarationEl);
}
export const TabsPageNgFactory:import16.ComponentFactory<import0.TabsPage> = new import16.ComponentFactory<import0.TabsPage>('ng-component',viewFactory_TabsPage_Host0,import0.TabsPage);
...
class _View_TabsPage0 extends import1.AppView<import0.TabsPage> {
  _el_0:any;
  /*private*/ _appEl_0:import3.AppElement;
  _Tabs_0_4:import17.Wrapper_Tabs;
  _text_1:any;
  _el_2:any;
  /*private*/ _appEl_2:import3.AppElement;
  _Tab_2_4:import18.Wrapper_Tab;
  _text_3:any;
  _el_4:any;
  /*private*/ _appEl_4:import3.AppElement;
  _Tab_4_4:import18.Wrapper_Tab;
  _text_5:any;
  _el_6:any;
  /*private*/ _appEl_6:import3.AppElement;
  _Tab_6_4:import18.Wrapper_Tab;
  _text_7:any;
  _el_8:any;
  /*private*/ _appEl_8:import3.AppElement;
  _Tab_8_4:import18.Wrapper_Tab;
  _text_9:any;
  _text_10:any;
  _map_0:any;
  /*private*/ _expr_5:any;
  ...
  createInternal(rootSelector:string):import3.AppElement {
    ...
    this._Tabs_0_4 = new import17.Wrapper_Tabs(this.parentInjector.get(import8.NavController,(null as any)),this.parentInjector.get(import19.ViewController,(null as any)),this.parentInjector.get(import10.App),this.parentInjector.get(import20.Config),new import21.ElementRef(this._el_0),this.parentInjector.get(import22.Platform),this.renderer,this.parentInjector.get(import23.DeepLinker));
    ...
    var compView_2:any = import18.viewFactory_Tab0(this.viewUtils,this.injector(2),this._appEl_2);
    this._Tab_2_4 = new import18.Wrapper_Tab(this._Tabs_0_4.context,this.parentInjector.get(import10.App),this.parentInjector.get(import20.Config),this.parentInjector.get(import24.Keyboard),new import21.ElementRef(this._el_2),this.parentInjector.get(import25.NgZone),this.renderer,this.parentInjector.get(import26.ComponentFactoryResolver),compView_2.ref,this.parentInjector.get(import27.GestureController),this.parentInjector.get(import28.TransitionController),this.parentInjector.get(import23.DeepLinker,(null as any)));
    ...
    var compView_4:any = import18.viewFactory_Tab0(this.viewUtils,this.injector(4),this._appEl_4);
    this._Tab_4_4 = new import18.Wrapper_Tab(this._Tabs_0_4.context,this.parentInjector.get(import10.App),this.parentInjector.get(import20.Config),this.parentInjector.get(import24.Keyboard),new import21.ElementRef(this._el_4),this.parentInjector.get(import25.NgZone),this.renderer,this.parentInjector.get(import26.ComponentFactoryResolver),compView_4.ref,this.parentInjector.get(import27.GestureController),this.parentInjector.get(import28.TransitionController),this.parentInjector.get(import23.DeepLinker,(null as any)));
    ...
    var compView_6:any = import18.viewFactory_Tab0(this.viewUtils,this.injector(6),this._appEl_6);
    ...
    var compView_8:any = import18.viewFactory_Tab0(this.viewUtils,this.injector(8),this._appEl_8);
    this._Tab_8_4 = new import18.Wrapper_Tab(this._Tabs_0_4.context,this.parentInjector.get(import10.App),this.parentInjector.get(import20.Config),this.parentInjector.get(import24.Keyboard),new import21.ElementRef(this._el_8),this.parentInjector.get(import25.NgZone),this.renderer,this.parentInjector.get(import26.ComponentFactoryResolver),compView_8.ref,this.parentInjector.get(import27.GestureController),this.parentInjector.get(import28.TransitionController),this.parentInjector.get(import23.DeepLinker,(null as any)));
...
export function viewFactory_TabsPage0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import3.AppElement):import1.AppView<import0.TabsPage> {
  if ((renderType_TabsPage === (null as any))) { (renderType_TabsPage = viewUtils.createRenderComponentType('',0,import15.ViewEncapsulation.None,styles_TabsPage,{})); }
