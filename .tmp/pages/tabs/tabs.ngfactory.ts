...
function viewFactory_TabsPage_Host0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import3.AppElement):import1.AppView<any> {
  if ((renderType_TabsPage_Host === (null as any))) { (renderType_TabsPage_Host = viewUtils.createRenderComponentType('',0,import11.ViewEncapsulation.None,([] as any[]),{})); }
  return new _View_TabsPage_Host0(viewUtils,parentInjector,declarationEl);
}
export const TabsPageNgFactory:import12.ComponentFactory<import0.TabsPage> = new import12.ComponentFactory<import0.TabsPage>('ng-component',viewFactory_TabsPage_Host0,import0.TabsPage);
...
class _View_TabsPage0 extends import1.AppView<import0.TabsPage> {
  ...
  detectChangesInternal(throwOnChange:boolean):void {
    ...
    const currVal_17:any = this._map_1(this.context.data,this.context.date);
    this._Tab_8_4.check_rootParams(currVal_17,throwOnChange,false);
    const currVal_18:any = 'PROFILE';
    this._Tab_8_4.check_tabTitle(currVal_18,throwOnChange,false);
    const currVal_19:any = 'contact';
...
export function viewFactory_TabsPage0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import3.AppElement):import1.AppView<import0.TabsPage> {
  if ((renderType_TabsPage === (null as any))) { (renderType_TabsPage = viewUtils.createRenderComponentType('',0,import11.ViewEncapsulation.None,styles_TabsPage,{})); }
