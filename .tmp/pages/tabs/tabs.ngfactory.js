...
export var Wrapper_TabsPage = (function () {
    function Wrapper_TabsPage(p0, p1, p2, p3, p4) {
        this.changed = false;
...
export var TabsPageNgFactory = new import14.ComponentFactory('ng-component', viewFactory_TabsPage_Host0, import0.TabsPage);
var styles_TabsPage = [];
...
var _View_TabsPage0 = (function (_super) {
    ...
    _View_TabsPage0.prototype.createInternal = function (rootSelector) {
        ...
        this._Tabs_0_4 = new import15.Wrapper_Tabs(this.parentInjector.get(import8.NavController, null), this.parentInjector.get(import17.ViewController, null), this.parentInjector.get(import18.App), this.parentInjector.get(import19.Config), new import20.ElementRef(this._el_0), this.parentInjector.get(import21.Platform), this.renderer, this.parentInjector.get(import22.DeepLinker));
        ...
        var compView_2 = import16.viewFactory_Tab0(this.viewUtils, this.injector(2), this._appEl_2);
        ...
        var compView_4 = import16.viewFactory_Tab0(this.viewUtils, this.injector(4), this._appEl_4);
        ...
        var compView_6 = import16.viewFactory_Tab0(this.viewUtils, this.injector(6), this._appEl_6);
        ...
        var compView_8 = import16.viewFactory_Tab0(this.viewUtils, this.injector(8), this._appEl_8);
        this._Tab_8_4 = new import16.Wrapper_Tab(this._Tabs_0_4.context, this.parentInjector.get(import18.App), this.parentInjector.get(import19.Config), this.parentInjector.get(import23.Keyboard), new import20.ElementRef(this._el_8), this.parentInjector.get(import24.NgZone), this.renderer, this.parentInjector.get(import25.ComponentFactoryResolver), compView_8.ref, this.parentInjector.get(import26.GestureController), this.parentInjector.get(import27.TransitionController), this.parentInjector.get(import22.DeepLinker, null));
    ...
    _View_TabsPage0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        ...
        if (((token === import28.Tab) && (8 === requestNodeIndex))) {
            return this._Tab_8_4.context;
        }
        if (((token === import29.Tabs) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 9)))) {
